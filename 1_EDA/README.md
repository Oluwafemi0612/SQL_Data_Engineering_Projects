...
1. [`01_top_demanded_skills.sql`](./01_top_demanded_skills.sql) - demand analysis with milti-table joins
2. [`02_top_paying_skills.sql`](./02_top_paying_skills.sql) - salary analysis with aggregation
3. [`03_optimal-skills.sql`](./03_optimal_skills.sql) - combined demand/salary optimization query
